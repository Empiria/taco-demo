"""
Based on code by jramboz originally published at:
https://anvil.works/forum/t/color-scheme-switcher/15816
"""
import anvil
...
def switch_colour_scheme(scheme: str):
    try:
        anvil.app.theme_colors.update(COLOR_SCHEMES[scheme])
    except KeyError:
        raise ValueError(f"{scheme} is not defined")
